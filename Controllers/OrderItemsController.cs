...
namespace ASUTask.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public OrderItemsController(AsuDbContext context)
        {
            _context = context;
        }
        ...
        {
            var asuDbContext = _context.OrderItems.Include(o => o.Order);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,Name,Quantity,Unit")] OrderItem orderItem)
        {
